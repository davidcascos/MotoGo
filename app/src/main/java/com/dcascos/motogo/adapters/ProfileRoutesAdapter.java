...
public class ProfileRoutesAdapter extends FirestoreRecyclerAdapter<Post, ProfileRoutesAdapter.ViewHolder> {
	...
	public ProfileRoutesAdapter(FirestoreRecyclerOptions<Post> options, Context context) {
		super(options);
